/*
RSSH Javascript Client

Usage:

var client = new RSSHClient();
...
client.connect({
    ...
    onConnect: function() {
        ...
        client.send('ls\n'); // You can send data back to the server by using RSSHClient.send()
    },
    onClose: function() {
...
RSSHClient.prototype._generateEndpoint = function(options) {
    ...
    var endpoint = protocol + window.location.host +
        '/rssh/' + encodeURIComponent(options.hostname) + '/' +
...
RSSHClient.prototype.connect = function(options) {
...
RSSHClient.prototype.send = function(data) {
